...
<div class="modal fade" id="reject_buy_order_modal" role="dialog"><!-- buying items on item-goods.php-->
	<div class="modal-dialog">
		<div class="modal-content">
		<div class="modal-header"> 
		<button type="button" class="close" data-dismiss="modal">&times;</button>
		...
		<div class="modal-body">							
			...
			<div class="modal-footer">
					<button class="btn btn-success" type="button" value="reject_buy_order_modal">Confirm</button>					
			</div>									
		</div>
		</div>
	</div></div>							
