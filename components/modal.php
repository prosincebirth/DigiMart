...
<div class="modal fade" id="dispute_item_delivered_dispute" role="dialog">
	...
	<div class="modal fade" id="deposit_gcash" role="dialog">
	<div class="vertical-alignment-helper">
	<div class="modal-dialog vertical-align-center">
	<div class="modal-content">
		<div class="modal-header">
		...
		<div class="modal-body">
			<form  method="GET" action="payment_gcash.php">
				...
				<div class="fld_input"><input type="email" name="email" placeholder="Email" required class="form-control"></div>						
	...
	<div class="modal fade" id="withdraw_gcash" role="dialog">
	<div class="vertical-alignment-helper">
	<div class="modal-dialog vertical-align-center">
	<div class="modal-content">
		<div class="modal-header">
