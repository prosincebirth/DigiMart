		...
		<br>
			...
			<div class="item_groups">
				...
				<div class="item_group--table">
					...
					<?php	$result = display_goods_buy_order($_GET['goods_id']);
							...
							<tbody>
								<tr>
									...
									<td>
										<span style="color: var(--black-color)">₱ <?php echo number_format($res['item_price'],2);?></span>
									...
									<td>
										<div class="item__group--cta">
											<a class="buy_btn wishlist_btn"  data-toggle="modal" data-target="#supply_item_modal" 
											data-item_price_h="<?php echo $res['item_price'];?>" 
											data-item_id_h="<?php echo $res['item_id'];?>"
											data-item_stock_h="<?php echo $res['item_quantity'];?>"
											data-seller_id_h="<?php if(isset($_SESSION['user_session'])){echo $_SESSION['user_session']; }?>" 
											data-buyer_id_h="<?php echo $res['user_id'];?>" 
